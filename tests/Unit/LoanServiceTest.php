...
class LoanServiceTest extends TestCase
{
    ...
    public function testServiceCanRepayAScheduledRepaymentConsecutively()
    {
        ...
        $this->assertDatabaseHas('scheduled_repayments', [
            ...
            'outstanding_amount' => 0,
            'currency_code' => $currencyCode,
            'due_date' => '2020-02-20', // last scheduled repayments should be 2020-04-20 right ?
            'status' => ScheduledRepayment::STATUS_REPAID,
        ]);
    ...
    public function testServiceCanRepayMultipleScheduledRepayments()
    {
        ...
        $this->assertDatabaseHas('scheduled_repayments', [
            'id' => $scheduledRepaymentOne->id,
            'loan_id' => $loan->id,
            'amount' => 1667, // first scheduled repayments amount should be 1666 ?
            'outstanding_amount' => 0,
            'currency_code' => $currencyCode,
            'due_date' => '2020-02-20',
            'status' => ScheduledRepayment::STATUS_REPAID,
        ...
        $this->assertDatabaseHas('scheduled_repayments', [
            'id' => $scheduledRepaymentTwo->id,
            'loan_id' => $loan->id,
            'amount' => 1667, // second scheduled repayments amount should be 1666 ?
            'outstanding_amount' => 333, // 2000 - 1667 ---> outstanding amount should be 1666 - 334 ?
            'currency_code' => $currencyCode,
            'due_date' => '2020-03-20',
